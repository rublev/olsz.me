...
function showResult(e) {
  ...
  const radius = Number.parseInt(document.querySelector('.radius').value, 10)
  const pixelSize = Number.parseInt(
    document.querySelector('.pixel_size').value,
    10,
  )
...
window.addEventListener('load', (e) => {
  ...
  if (radius && Number.parseInt(radius, 10)) {
    document.querySelector('.radius').value = Number.parseInt(radius, 10)
  }

  if (multiplier && Number.parseInt(multiplier, 10)) {
    document.querySelector('.pixel_size').value = Number.parseInt(
      multiplier,
      10,
    )
  }
  ...
  if (border && border === '1') {
    ...
    if (borderwidth && Number.parseInt(borderwidth, 10)) {
      document.querySelector('.borderwidth').value = Number.parseInt(
        borderwidth,
        10,
      )
    }
