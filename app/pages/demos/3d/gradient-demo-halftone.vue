...
onMounted(async () => {
  ...
  const material = new THREE.ShaderMaterial({
    uniforms: {
      u_bg: { type: 'v3', value: rgb(255, 255, 0) }, // Background color
      u_bgMain: { type: 'v3', value: rgb(255, 0, 0) }, // Main background
      u_color1: { type: 'v3', value: rgb(0, 255, 0) }, // First gradient color
      u_color2: { type: 'v3', value: rgb(0, 0, 255) }, // Second gradient color
